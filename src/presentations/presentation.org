...
** Day #1- Date: 2017-03-15
   ...
   |    8 | 16:00 | TEA-BREAK                                 |                        |
   |    7 | 16:15 | Using College Cloud Edition for Workshops | Sripathi               |
   |------+-------+-------------------------------------------+------------------------|
...
*** Demo of College Cloud Edition
    ...
    - Connect to College Cloud Edition (IP or domain name)
    ...
    - Enroll into a course (decide)
    - Perform the experiment (decide)
    - Submit the feedback (decide)
*** Training on College Cloud Edition Installation.
    ...
    - Must have it printed . Toggle must be avoided 
...
Workshop process links -
Mapping link to be given - to be taken from Ravi Kiran 
