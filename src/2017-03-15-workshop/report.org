...
* Overview 
In order to ensure availability of Virtual Lab experiments to all
those colleges and students who have poor internet connectivity, VLEAD
developed the College Cloud Edition of the Virtual Labs.  This version
has been piloted and tested by VLEAD engineers. The methodology,
operating process and the method of using this edition has been made
available to the Outreach members, Nodal Center representatives and
participating colleges.  

The 4th Integration Workshop on Virtual Labs College Cloud Edition,
detailed in the report below was conducted by the VLEAD team to
train,give hands on deployment experience and to handover copies of
the College Cloud Edition drives. Healthy and open interactions among
the participants from various institutes of the consortium helped give
a clear understanding and build confidence in the teams be able to
effectively deploy and use the College Cloud Edition in the workshops
conducted by them. The feedback from the participants was good and
positive.
 
The participating teams will conduct at least 2 workshops and share
the feedback along with their own experience of using the College
Cloud edition. VLEAD team will be available to them real time for
supporting any issues arising during the deployment and use.
...
** Participants ( 17 Participants from 8 institutes) 
   |------+-----------------------+-------------------------------+-----------------------|
   | S.No | Partipant's Name      | Institute Name                | Designation           |
   |------+-----------------------+-------------------------------+-----------------------|
   |   1. | Mr. Dhananjay Umrao   | IIT Kanpur                    | Project Engineer      |
   |------+-----------------------+-------------------------------+-----------------------|
   |   2. | Mr. Vaibhav Kurhe     | COE Pune                      | Software Developer    |
   |------+-----------------------+-------------------------------+-----------------------|
   |   3. | Ms. Nilima Thigale    | COE Pune                      | Software Developer    |
   |------+-----------------------+-------------------------------+-----------------------|
   |   4. | Mr. Chetan Dhiman     | IIT Roorkee                   | Integration Engineer  |
   |------+-----------------------+-------------------------------+-----------------------|
   |   5. | Mr. Amit Kumar Sharma | IIT Roorkee                   | Project Associate     |
   |------+-----------------------+-------------------------------+-----------------------|
   |   6. | Mr. Hrishikesh Baruah | IIT Guwahati                  | Project Engineer      |
   |------+-----------------------+-------------------------------+-----------------------|
   |   7. | Mr. Nanu Alan Kachari | IIT Guwahati                  | Technical Officer     |
   |------+-----------------------+-------------------------------+-----------------------|
   |   8. | Mr. Ajaykant Upadhyay | Dayalbagh Education Institute | Project Associate     |
   |------+-----------------------+-------------------------------+-----------------------|
   |   9. | Mr. Dinesh            | Dayalbagh Education Institute | Project Associate     |
   |------+-----------------------+-------------------------------+-----------------------|
   |  10. | Mr. Ashish Mudgil     | IIT Delhi                     | Field Engineer        |
   |------+-----------------------+-------------------------------+-----------------------|
   |  11. | Mr. Mohak Kaushik     | IIT Delhi                     | System Administrator  |
   |------+-----------------------+-------------------------------+-----------------------|
   |  12. | Mr. Srinath           | TASK                          | -                     |
   |------+-----------------------+-------------------------------+-----------------------|
   |  13. | Mr. Sai               | TASK                          | -                     |
   ...
   |  14. | Mr. Vijay             | TASK                          | -                     |
   |------+-----------------------+-------------------------------+-----------------------|
   |  15. | Ms. Akshaya           | NIT Surathkal                 | Junior Researh Fellow |
   |------+-----------------------+-------------------------------+-----------------------|
   |  16. | Ms. Anush             | NIT Surathkal                 | Junior Researh Fellow |
   |------+-----------------------+-------------------------------+-----------------------|
   |  17. | Ms. Swati             | NIT Surathkal                 | Junior Researh Fellow |
   |------+-----------------------+-------------------------------+-----------------------|
...
* Objectives of the Workshop
  ...
  + Get trained to assist the Nodal Coordinators in conducting
    workshops using Virtual Labs College Cloud Edition.


* Summary of the Workshop
** First Day : March 15, 2017
*** Registration of participants ( 9:30 AM to 10:00 AM )       
...
*** Welcome Address by Professor Venkatesh Choppella ( 10:00 AM to 10:20 AM )
...
*** VLEAD process and best practices  by Mr. Thirumal Ravula ( 10:20 AM to 10:40 AM )
...
*** Ice Breaking session with Ms. Priya Raman ( 10:40 AM to 10:45 AM )
...
*** Agenda of workshop by Mr. Ashay Maheshwari ( 10:45 AM to 10:50 AM )
...
*** Portable version of Virtual Labs by COE Pune by Mr. Vaibhav Khure ( 10:50 AM to 11:00 AM )
...
*** Introduction to College Cloud Edition by Mr. Ashay Maheshwari ( 11:00 AM to 11:15 AM )
...
*** Demo of College Cloud Edition byy Mr. Shiva and Mr. Ashay (Assisted by Mr. Raghupati, Mr. Sripathi, Ms. Sanchita) ( 11:45 AM to 1:00 PM )
...
* Feedback from participants on the Virtual Labs 4th Integration Workshop : College Cloud Edition 
  ...
  + Q :: The workshop covered what was stated in the announcement 
    + =64.7 %= of the participants gave a score of =5/5= (Completely)
    + =35.3 %= of the participants gave a score of =4/5=

  + Q :: The workshop was relevant to your work 
    + =70.6 %= of the participants gave a score of  =5/5= (Yes, very relevant)
    + =17.6 %= of the participants gave a score of =4/5=
    + =11.6 %= of the participants gave a score of =3/5= 

  + Q :: The program was well placed within the alloted time 
    + =100 %= of the participants agreed and gave a score of =4/5= and =5/5= (Yes, very much)

  + Q :: I will recommend this workshop to others in my team 
    + =70.6 %= of the participants gave a score of =5/5= (Yes)
    + =23.5 %= of the participants gave a score of =4/5=
    + =05.9 %= of the participants gave a score of =3/5=


  + Q :: All the instructors were good communicators 
    + =70.6 %= of the participants gave a score of =5/5= (All were good)
    + =11.8 %= of the participants gave a score of =4/5= 
    + =17.6 %= of the participants gave a score of =3/5=

  + Q :: The material was presented in an organized manner 
    + =94.1 %= of the paricipants gave a score of =4/5= and =5/5= (very well organised)
    + =05.9 %= of the participants have a score of =2/5=    

  + Q :: The Instructors were knowledgeable on the topic 
    + =100 %= of the paricipants gave a score of =4/5= and =5/5= (In command of the subject)

  + Q :: The duration of the workshop was 
    + =82.4 %= of the participants said it was =Right duration=
    + =11.8 %= of the participants said it was =Too long=
    + =05.9 %= of the participants said it was =Too short=
     
  + Q :: All the details needed for the implementation were provided 
    + =94.1 %= felt that all the details for implementation were provided. (very well)
    + =05.9 %= felt that things we missing.

  + Q :: Rate your overall experience 
    + =41.2 %= of the participants gave a score of 5/5 (Very Good)
    + =52.9 %= of the participants gave a score of 4/5
    + =05.9 %= of the participants gave a score of 3/5

  + Q :: Do you feel confident that you will be able to do the College Cloud deployment correctly ? 
    + =47.1 %= of the participants gave a score of =5/5= (very well)
    + =41.1 %= of the participants gave a score of =4/5= 
    + =11.8 %= of the participants gave a score of =3/5=
...
* Things that went well
  ...
  + Interaction between participants and VLEAD was productive.
...
* Photographs 
  [[https://drive.google.com/open?id=0B_TJToQnEM4tZUNmam1IbVJ1NDA][Photographs - Virtual Labs 4th Integration Workshop]]


* Attendance 
  Attendance sheet for Virtual Labs 4th Integration Workshop is
  [[https://drive.google.com/open?id=0B_TJToQnEM4tU3BVQUZoVDk1bTQ][available on drive]]. Contact numbers are hidden for privacy reasons.
